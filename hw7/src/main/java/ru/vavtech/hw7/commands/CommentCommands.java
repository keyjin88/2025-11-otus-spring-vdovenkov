...
public class CommentCommands {
    ...
    @Command(name = "bcs", description = "Показать комментарии к книге", group = "Комментарии")
    public String showComments(
            @Option(shortName = 'b', longName = "bookId", description = "Id книги", required = true) long bookId
    ) {
    ...
    public String updateComment(
            @Option(shortName = 'c', longName = "commentId",
                    description = "Id комментария", required = true) long commentId,
    ...
    public String addCommentForBook(
            @Option(shortName = 'b', longName = "bookId", description = "Id книги", required = true) long bookId,
